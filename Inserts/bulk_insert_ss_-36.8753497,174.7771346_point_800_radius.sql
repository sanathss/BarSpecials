...
insert_datetime)
 ...
 UNION 
 SELECT 'ChIJV5aCtH9IDW0RT7ahAGNeRUo',
 'Hell Pizza',
 -36.8807622,
 174.7757242,
 4,
 ...
 'AddStores',
 GETDATE()
 WHERE NOT EXISTS(SELECT 1 FROM dbo.uo_store st WHERE st.store_identifier = 'ChIJV5aCtH9IDW0RT7ahAGNeRUo') 
 UNION 
 ...
 UNION 
 SELECT 'ChIJxeRPq39IDW0RW_V4I6H5zlM',
 'Da Sette Soldi Restaurant & Takeaways',
 -36.8801711,
 174.7759095,
 4,
 'username',
 ...
 'AddStores',
 GETDATE()
 WHERE NOT EXISTS(SELECT 1 FROM dbo.uo_store st WHERE st.store_identifier = 'ChIJxeRPq39IDW0RW_V4I6H5zlM') 
 UNION 
 ...
 UNION 
 SELECT 'ChIJhxvOyH9IDW0RJ8QRdBMhIXw',
 'Dragon''s Gourmet',
 -36.8813244,
 174.7756409,
 4,
 ...
 'AddStores',
 GETDATE()
 WHERE NOT EXISTS(SELECT 1 FROM dbo.uo_store st WHERE st.store_identifier = 'ChIJhxvOyH9IDW0RJ8QRdBMhIXw') 
 UNION 
 ...
 UNION 
 SELECT 'ChIJt6nuVH5IDW0Rd9r3-3D0-Ns',
 'MiSS BAO (Gourmet kitchen)',
 -36.880071,
 174.775972,
 4,
 'username',
 ...
 'AddStores',
 GETDATE()
 WHERE NOT EXISTS(SELECT 1 FROM dbo.uo_store st WHERE st.store_identifier = 'ChIJt6nuVH5IDW0Rd9r3-3D0-Ns') 
 UNION 
 ...
 UNION 
 SELECT 'ChIJAR8wq39IDW0RzZynV-Ud2Kg',
 'Alligators of Epsom',
 -36.8800545,
 174.7759075,
 4,
 ...
 'AddStores',
 GETDATE()
 WHERE NOT EXISTS(SELECT 1 FROM dbo.uo_store st WHERE st.store_identifier = 'ChIJAR8wq39IDW0RzZynV-Ud2Kg') 
 UNION 
